...
function HeaderCustomerPaymentConfirmation() {
  const { dictionary } = useDictionary()
  return (
    <div className="py-10">
      <div className="flex flex-col-reverse justify-between gap-4 lg:flex-row lg:items-center">
        <HeaderInformationLayout>
          <HeaderLabel label={dictionary.Buy}>Buy USDT From Jonathan Higgins</HeaderLabel>
...
export default memo(HeaderCustomerPaymentConfirmation, isEqual)
