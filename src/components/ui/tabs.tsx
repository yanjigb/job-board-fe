...
const TabsTriggerRoot = TabsPrimitive.Trigger
const TabsListRoot = TabsPrimitive.List
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex space-x-1 rounded-lg bg-dark-3 p-1', 'tabs-list', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'min-w-[5rem] rounded-sm px-3 py-2 font-semibold text-text-primary data-[state=active]:bg-button-type-p2p data-[state=active]:text-text-dark',
      'tabs-trigger',
      className,
    )}
    {...props}
...
export { Tabs, TabsList, TabsTrigger, TabsContent, TabsTriggerRoot, TabsListRoot }
